<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceptionistPhoneCallEmergency.aspx.cs" Inherits="Receptionist_ReceptionistPhoneCallEmergency" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="../css/Receptionist/ReceptionistPhoneCallEmergencyStyle.css" />
    <link rel="stylesheet" href="../css/jquery.timepicker.css" />
    <script type="text/javascript" src="../js/jquery.js"></script>
    <script type="text/javascript" src="../js/jquery.timepicker.js"></script>
    <script type="text/javascript" src="../js/Receptionist/ReceptionistPhoneCallEmergencyScript.js"></script>
</head>
<body>
    ...
    <div id="center1">
        <br />
        <center>
            <img src="../images/icon12.png" /><span class="heading">Emergency Phone Call</span>
        </center>
        <br />
    </div>
    <br />
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Please enter phone no. in correct format" ControlToValidate="TextBox6" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationExpression="[0-9]*"></asp:RegularExpressionValidator>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please enter phone no." ControlToValidate="TextBox6" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="td1">
                        ...
                        <tr>
                            <td class="td1">
                                <span class="span1"><b style="color:red">*</b>Caller Area:</span>
                            </td>
                            <td style="text-align:center">
                                <asp:TextBox ID="TextBox5" runat="server" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please enter caller area" ControlToValidate="TextBox5" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="td1">
                                <span class="span1"><b style="color:red">*</b>Emergency Details:</span>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please enter emergency details" ControlToValidate="TextBox4" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
