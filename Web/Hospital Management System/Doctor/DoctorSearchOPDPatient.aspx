<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorSearchOPDPatient.aspx.cs" Inherits="Doctor_DoctorSearchOPDPatient" %>
...
<head id="Head1" runat="server">
    <title></title>
    <link rel="stylesheet" href="../css/Doctor/DoctorSearchOPDPatientStyle.css" />
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <center>
                    <div>
                        <center>
                            <img src="../images/icon2.png" /><span class="heading">Search OPD Patient</span>
                        </center>
                        ...
                        <fieldset>
                            ...
                            <asp:GridView ID="GridView1" AllowPaging="True" runat="server" AutoGenerateColumns="False" AlternatingRowStyle-BackColor="Wheat" HeaderStyle-BackColor="YellowGreen" RowStyle-HorizontalAlign="Center" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="600px" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound" PagerStyle-HorizontalAlign="Center" PagerStyle-VerticalAlign="Middle" PagerSettings-Mode="NumericFirstLast">
