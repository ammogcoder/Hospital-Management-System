<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorIPDWardTransfer.aspx.cs" Inherits="Doctor_DoctorIPDWardTransfer" %>
...
<head runat="server">
    <title></title>
    <link rel="stylesheet" href="../css/Doctor/DoctorIPDWardTransferStyle.css" />
    <link rel="stylesheet" href="../css/jquery.timepicker.css" />
    <script type="text/javascript" src="../js/jquery.js"></script>
    <script type="text/javascript" src="../js/jquery-ui.js"></script>
    <script type="text/javascript" src="../js/jquery.timepicker.js"></script>
    <script type="text/javascript" src="../js/Doctor/DoctorIPDWardTransferScript.js"></script>
</head>
<body>
                        ...
                        <center>
                            <div>
                                <asp:Panel ID="Panel1" runat="server" Width="500px">
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="IPD Ward Transferred" BackColor="Yellow" Font-Bold="true" Visible="false"></asp:Label>
                                    <fieldset id="fieldset1">
                                        <legend id="legend1">Ward Transfer Details</legend>
                                        <div>
                                            <table id="table2">
                                                <tr>
                                                    <td class="td1">
