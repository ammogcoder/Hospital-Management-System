...
public class PreviousAppointmentsAdapter extends ArrayAdapter<String>
{
	...
	public PreviousAppointmentsAdapter(Context context, List<String> appointmentDateList, List<String> appointmentTimeList, List<String> doctorList)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		View v=inflater.inflate(R.layout.row_appointments, parent);
		...
		textview_doctor_name.setText(doctorList.get(position));
		textview_appointment_date.setText(appointmentDateList.get(position));
		textview_appointment_time.setText(appointmentTimeList.get(position));
		return v;
	}
}
