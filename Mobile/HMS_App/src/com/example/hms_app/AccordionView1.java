...
public class AccordionView1 extends LinearLayout {
  ...
  public AccordionView1(Context context, AttributeSet attrs) {
    super(context, attrs);
  ...
  private View getView(final LayoutInflater inflater, int i, boolean hide) {
    ...
    FontUtils.setCustomFont(container, AccordionView1.this.getContext().getAssets());
  ...
  private View getViewHeader(LayoutInflater inflater, final int position, boolean hide) {
    ...
    FontUtils.setCustomFont(view, AccordionView1.this.getContext().getAssets());
    ...
    if (foldButton instanceof ToggleImageLabeledButton1) {
      final ToggleImageLabeledButton1 toggleButton = (ToggleImageLabeledButton1) foldButton;
